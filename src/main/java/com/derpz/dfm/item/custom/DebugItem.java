...
public class DebugItem extends Item {
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundBlock) {
                player.sendMessage(new TranslatableComponent("item.dfm.debug_item.no_valuables"),
                        player.getUUID());
            }
        }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
       if(Screen.hasShiftDown()) {
           pTooltipComponents.add(new TranslatableComponent("tooltip.dfm.debug_item.tooltip.shift"));
       }
       else {
           pTooltipComponents.add(new TranslatableComponent("tooltip.dfm.debug_item.tooltip"));
       }
    }
