...
public class NukaColaMachineBlockModel extends GeoModel<NukaColaMachineBlockEntity> {
    @Override
    public ResourceLocation getModelResource(NukaColaMachineBlockEntity animatable) {
        return new ResourceLocation(FalloutMod.MOD_ID, "geo/nuka_cola_machine.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(NukaColaMachineBlockEntity animatable) {
        return new ResourceLocation(FalloutMod.MOD_ID, "textures/block/nuka_cola_machine.png");
    }

    @Override
    public ResourceLocation getAnimationResource(NukaColaMachineBlockEntity animatable) {
