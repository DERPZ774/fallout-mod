...
/*
    ...
    public InteractionResult useOn(UseOnContext pContext) {
        if(pContext.getLevel().isClientSide()) {
            ...
            if(!foundBlock) {
                player.sendSystemMessage(Component.translatable("item.nukaisles.debug_item.no_valuables"));
            }
        }
    ...
    private void addNbtToDataTablet(Player player, BlockPos pos, Block blockBelow) {
        ...
        nbtData.putString("nukaisles.last_ore", "Found " + blockBelow.getName() + " at (" +
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
       if(Screen.hasShiftDown()) {
           pTooltipComponents.add(Component.translatable("tooltip.nukaisles.debug_item.tooltip.shift"));
       }
       else {
           pTooltipComponents.add(Component.translatable("tooltip.nukaisles.debug_item.tooltip"));
       }
    }
